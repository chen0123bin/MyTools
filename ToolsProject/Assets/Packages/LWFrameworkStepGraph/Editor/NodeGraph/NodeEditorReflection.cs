...
namespace LWNodeEditor {
    ...
    public static class NodeEditorReflection {
        ...
        public static Type[] GetNodeTypes() {
            ...
            return GetDerivedTypes(typeof(LWNode.Node));
        }
        ...
        public static bool TryGetAttributeTint(this Type nodeType, out Color tint) {
            if (nodeTint == null) {
                CacheAttributes<Color, LWNode.Node.NodeTintAttribute>(ref nodeTint, x => x.color);
            }
        ...
        public static bool TryGetAttributeWidth(this Type nodeType, out int width) {
            if (nodeWidth == null) {
                CacheAttributes<int, LWNode.Node.NodeWidthAttribute>(ref nodeWidth, x => x.width);
            }
        ...
        public static FieldInfo GetFieldInfo(this Type type, string fieldName) {
            ...
            while (field == null && (type = type.BaseType) != typeof(LWNode.Node)) field = type.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
            return field;
        }
