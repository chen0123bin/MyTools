        ...
        private void OnGUI() {
            ...
            if (input == null || input.Trim() == "") {
                if (GUILayout.Button("Revert to default") || (e.isKey && e.keyCode == KeyCode.Return)) {
                    ...
                    NodeEditor.GetEditor((LWNode.Node)target, NodeEditorWindow.current).OnRename();
                    AssetDatabase.SetMainObject((target as LWNode.Node).graph, AssetDatabase.GetAssetPath(target));
