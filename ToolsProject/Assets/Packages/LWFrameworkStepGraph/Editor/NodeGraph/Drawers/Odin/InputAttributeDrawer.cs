...
namespace LWNodeEditor {
	public class InputAttributeDrawer : OdinAttributeDrawer<LWNode.Node.InputAttribute> {
		...
		protected override void DrawPropertyLayout(GUIContent label) {
			...
			if (!NodeEditor.inNodeEditor) {
				if (Attribute.backingValue == LWNode.Node.ShowBackingValue.Always || Attribute.backingValue == LWNode.Node.ShowBackingValue.Unconnected && !port.IsConnected)
